...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_node', 'extra_action', self.gf('forum.models.action.ActionField')(related_name='extra_node', null=True, to=orm['forum.Action']), keep_default=False)

        # Adding field 'Node.deleted'
        db.add_column('forum_node', 'deleted', self.gf('forum.models.action.ActionField')(related_name='deleted_node', unique=True, null=True, to=orm['forum.Action']), keep_default=False)

        # Adding field 'Node.last_edited'
        db.add_column('forum_node', 'last_edited', self.gf('forum.models.action.ActionField')(related_name='edited_node', unique=True, null=True, to=orm['forum.Action']), keep_default=False)
