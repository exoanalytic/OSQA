...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        f_count = orm.FavoriteQuestion.objects.count()
        print "\nConverting %d favorites:" % f_count
        progress = ProgressBar(f_count)

        for f in orm.FavoriteQuestion.objects.all():
            fn = orm.FavoriteNode(
                node = f.question.node_ptr,
                user = f.user,
                added_at = f.added_at,
            )
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 27, 11, 59, 36, 107000)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 28, 11, 59, 36, 196000)'}),
